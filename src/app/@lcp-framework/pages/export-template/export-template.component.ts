    ...
    this.gridApiService.getAllList(params).subscribe(
      (response) => {
        if (response.status && response.code === 200) {
          ...
          const pdfGroup = this.form.get('pdfDetails') as FormGroup;
          pdfGroup.patchValue({
            pdf_page_size: entity.pdf_page_size || 'A4',
            pdf_orientation: entity.pdf_orientation || 'portrait',
            pdf_margin_top: entity.pdf_margin_top ?? 20,
            pdf_margin_bottom: entity.pdf_margin_bottom ?? 20,
            pdf_margin_left: entity.pdf_margin_left ?? 15,
            pdf_margin_right: entity.pdf_margin_right ?? 15,
            pdf_color_theme: entity.pdf_color_theme || 'light',
            pdf_font_family: entity.pdf_font_family || 'Helvetica',
            pdf_font_size: entity.pdf_font_size ?? 12,
            pdf_is_paginated: entity.pdf_is_paginated ?? false,
            pdf_is_header_enabled: entity.pdf_is_header_enabled ?? false,
            pdf_is_footer_enabled: entity.pdf_is_footer_enabled ?? false,
            pdf_template_header: entity.pdf_template_header || '',
            pdf_template_footer: entity.pdf_template_footer || '',
            pdf_template_content: entity.pdf_template_content || '',
            pdf_is_repeatative_header: entity.pdf_is_repeatative_header ?? false,
            pdf_is_repeatative_footer: entity.pdf_is_repeatative_footer ?? false,
            pdf_is_first_page_header_only: entity.pdf_is_first_page_header_only ?? false,
            pdf_is_first_page_footer_only: entity.pdf_is_first_page_footer_only ?? false,
            pdf_is_watermark_enabled: entity.pdf_is_watermark_enabled ?? false,
            pdf_watermark_text: entity.pdf_watermark_text || '',
            pdf_watermark_image: entity.pdf_watermark_image || '',
            pdf_watermark_position: entity.pdf_watermark_position || 'center',
          });
    ...
    const master = [
      {
        ...
        pdf_page_size: formData?.pdfDetails?.pdf_page_size ?? 'A4',
        pdf_orientation: formData?.pdfDetails?.pdf_orientation ?? 'portrait',
        pdf_margin_top: formData?.pdfDetails?.pdf_margin_top ?? 20,
        pdf_margin_bottom: formData?.pdfDetails?.pdf_margin_bottom ?? 20,
        pdf_margin_left: formData?.pdfDetails?.pdf_margin_left ?? 15,
        pdf_margin_right: formData?.pdfDetails?.pdf_margin_right ?? 15,
        pdf_color_theme: formData?.pdfDetails?.pdf_color_theme ?? 'light',
        pdf_font_family: formData?.pdfDetails?.pdf_font_family ?? 'Helvetica',
        pdf_font_size: formData?.pdfDetails?.pdf_font_size ?? 12,
        pdf_is_paginated: formData?.pdfDetails?.pdf_is_paginated ?? false,
        pdf_is_header_enabled: formData?.pdfDetails?.pdf_is_header_enabled ?? false,
        pdf_is_footer_enabled: formData?.pdfDetails?.pdf_is_footer_enabled ?? false,
        pdf_template_header: formData?.pdfDetails?.pdf_template_header ?? '',
        pdf_template_footer: formData?.pdfDetails?.pdf_template_footer ?? '',
        pdf_template_content: formData?.pdfDetails?.pdf_template_content ?? '',
        pdf_is_repeatative_header: formData?.pdfDetails?.pdf_is_repeatative_header ?? false,
        pdf_is_repeatative_footer: formData?.pdfDetails?.pdf_is_repeatative_footer ?? false,
        pdf_is_first_page_header_only: formData?.pdfDetails?.pdf_is_first_page_header_only ?? false,
        pdf_is_first_page_footer_only: formData?.pdfDetails?.pdf_is_first_page_footer_only ?? false,
        pdf_is_watermark_enabled: formData?.pdfDetails?.pdf_is_watermark_enabled ?? false,
        pdf_watermark_text: formData?.pdfDetails?.pdf_watermark_text ?? '',
        pdf_watermark_image: formData?.pdfDetails?.pdf_watermark_image ?? '',
        pdf_watermark_position: formData?.pdfDetails?.pdf_watermark_position ?? 'center',
        created_by: true,
      },
    ];
