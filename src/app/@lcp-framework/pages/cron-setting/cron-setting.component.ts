...
export class CronSettingComponent implements OnInit, OnDestroy {
  ...
  setHeader() {
    this.headerColumnData = [
      ...
      },
      {
        header: 'uuid',
        clause_type: 'where',
        field_value: 'scheduled_jobs.uuid',
        is_sortable: 'false',
        column_order: '0.00',
        column_width: '1.00',
        is_searchable: 'false',
      ...
      },
      {
        header: 'timing',
        clause_type: 'where',
        field_value: 'scheduled_jobs.timing',
        is_sortable: 'true',
        column_order: '0.00',
        column_width: '1.00',
        is_searchable: 'true',
      ...
      },
      {
        header: 'cron_url',
        clause_type: 'where',
        field_value: 'scheduled_jobs.cron_url',
        is_sortable: 'true',
        column_order: '0.00',
        column_width: '1.00',
        is_searchable: 'true',
      ...
      {
        header: 'concat_base_url',
        clause_type: 'where',
        field_value: "CASE WHEN scheduled_jobs.concat_base_url THEN 'YES' ELSE 'NO' END",
        is_sortable: 'true',
        column_order: '1.00',
        column_width: '1.00',
        is_searchable: 'true',
      ...
      },
      {
        header: 'description',
        clause_type: 'where',
        field_value: 'scheduled_jobs.description',
        is_sortable: 'true',
        column_order: '2.00',
        column_width: '2.00',
        is_searchable: 'true',
...

      {
        header: 'cron_status',
        clause_type: 'where',
        field_value: "CASE WHEN scheduled_jobs.status_id = 1 THEN 'Running' ELSE 'Stopped' END",
        is_sortable: 'true',
        column_order: '5.00',
        column_width: '1.00',
        is_searchable: 'false',
      ...
      },
      {
        header: 'created_at',
        clause_type: 'where',
        field_value: 'scheduled_jobs.created_at',
        is_sortable: 'false',
        column_order: '6.00',
        column_width: '1.00',
        is_searchable: 'false',
  ...
  setDefaultQuery() {
    this.defaultQuery = {
      ...
      start_index: 0,
      limit_range: 10,
      sort_columns: [['scheduled_jobs.id', 'desc']],
      group_by: [
        'scheduled_jobs.timing',
        'scheduled_jobs.cron_url',
        'scheduled_jobs.concat_base_url',
