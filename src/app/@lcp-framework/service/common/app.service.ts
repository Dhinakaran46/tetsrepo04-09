...
export class AppService {
  storeData: any;
  constructor(public translate: TranslateService, public store: Store<any>, private languageService: LanguageService) {
    this.initStoreData();
  }
  ...
  initStoreData() {
    ...
    val = localStorage.getItem('fontsize'); // small, medium, large
    val = val || $themeConfig.fontsize;
    this.store.dispatch({ type: 'toggleFontSize', payload: val });
    ...
    this.languageService.fetchLanguageData(1, languageId);
  }
