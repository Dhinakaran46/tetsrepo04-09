...
export function indexReducer(state = initialState, action: any) {
  ...
  } else if (type === 'toggleFontSize') {
    payload = payload || state.fontsize; // small, medium, large

    localStorage.setItem('fontsize', payload);
    if (payload == 'medium') {
      document.querySelector('body')?.classList.remove('app-small-font');
      document.querySelector('body')?.classList.remove('app-large-font');
      document.querySelector('body')?.classList.add('app-medium-font');
    } else if (payload == 'large') {
      document.querySelector('body')?.classList.remove('app-small-font');
      document.querySelector('body')?.classList.remove('app-medium-font');
      document.querySelector('body')?.classList.add('app-large-font');
    } else {
      document.querySelector('body')?.classList.remove('app-medium-font');
      document.querySelector('body')?.classList.remove('app-large-font');
    }
